...
int BRC_port = 10002;
int BRC_WebBodySize = 5807;

String[] BRC_ids = new String[] {}
;String[] BRC_values = new String[] {};

String[] BRC_Monitors = new String[] {"bombsLeft"};
...
+ "*/\n"
+ "\n"
+ "const Controls=[[\"MONITOR\",\"brc_1\",\"bombsLeft\"]];\n"
+ "\n"
+ "Monitor = true;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "\n"
+ "<table><tr><td><table><tr><td class=\"auto-style1\">Mines Remaining <label id=\"brc_1\" class=\"monitor\">N/A</label>\n"
+ "</td></tr></table>\n"
+ "\n"
+ "</td></tr></table>\n"
+ "\n"
